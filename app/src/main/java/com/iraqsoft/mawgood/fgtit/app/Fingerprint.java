...
public class Fingerprint {
	...
	public void Open(){
		...
		vFingerprint.setOnRS485Listener(new AsyncFingerprint.OnRS485Listener(){
			@Override
		...
		vFingerprint.setOnRS485exListener(new AsyncFingerprint.OnRS485exListener(){
			@Override
		...
		vFingerprint.setOnGetIdCardNOListener(new AsyncFingerprint.OnPSGetIdCardNOListener() {
			@Override
	...
	public void Process(){
		bfpWork = false;
		if(!bfpWork){
			if (vFingerprint!= null) {
                Log.d("Fingerprint", "bIsCancel:" + bIsCancel);
				bIsCancel = false;
				SendMessage(STATE_PLACE, null);
				vFingerprint.FP_GetImage();
				bfpWork = true;
